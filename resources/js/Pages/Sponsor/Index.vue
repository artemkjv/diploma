    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between">
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Sponsors</h2>
                <Link
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="relative overflow-x-auto">
                        <table v-if="sponsors.data.length > 0" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead
                            ...
                            <tr v-for="(sponsor, index) in sponsors.data" :key="index"
                                ...
                                <td class="px-6 py-4">
                                    <Dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            <DropdownLink :href="route('sponsors.edit', {'id': sponsor.id})">
                                                Edit
                                            </DropdownLink>
                                            <DropdownLink :href="route('sponsors.destroy', {'id': sponsor.id})" method="delete" as="button">
                                                Delete
                                            </DropdownLink>
                                        </template>
                                    </Dropdown>
