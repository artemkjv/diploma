            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="relative overflow-x-auto">
                        <table v-if="users.data.length > 0" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            <thead
                            ...
                            <tr v-for="(user, index) in users.data" :key="index"
                                ...
                                <td class="px-6 py-4">
                                    <Dropdown align="right" width="48">
                                        ...
                                        <template #content>
                                            <DropdownLink :href="route('users.edit', {'id': user.id})">
                                                Edit
                                            </DropdownLink>
                                            <DropdownLink :href="route('users.destroy', {'id': user.id})" method="delete" as="button">
                                                Delete
                                            </DropdownLink>
                                        </template>
                                    </Dropdown>
